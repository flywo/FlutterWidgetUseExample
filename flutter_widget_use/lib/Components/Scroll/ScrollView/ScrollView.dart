...
import 'package:flutter_widget_use/Code/ScrollView.dart';
...
class ScrollView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WidgetUseShowView(
      title: "ScrollView",
      nextPath: "lib/Code/ScrollView.dart",
      next: ScrollViewDemo(),
      markdown: contentText0 + contentText1,
      url: 'https://docs.flutter.io/flutter/widgets/ScrollView-class.html',
    );
  }
}
