...
import 'package:flutter_widget_use/Code/AssetImage.dart';
...
class MyAssetImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WidgetUseShowView(
      title: "AssetImage",
      next: AssetImageDemo(),
      nextPath: "lib/Code/AssetImage.dart",
      markdown: contentText0 + contentText1,
      url: 'https://docs.flutter.io/flutter/painting/AssetImage-class.html',
    );
  }
}
