...
import 'package:flutter_widget_use/Code/TextField.dart';
...
class TextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WidgetUseShowView(
      ...
      nextPath: "lib/Code/TextField.dart",
      markdown: _textFieldText0 + _textFieldText1 + _textFieldText2,
      url: "https://docs.flutter.io/flutter/material/TextField-class.html",
    );
  }
}
