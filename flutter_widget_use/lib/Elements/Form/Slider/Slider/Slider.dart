...
import 'package:flutter_widget_use/Code/Slider.dart';
...
class Slider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WidgetUseShowView(
      ...
      nextPath: "lib/Code/Slider.dart",
      markdown: contentA + contentB,
      url: 'https://docs.flutter.io/flutter/material/Slider-class.html',
    );
  }
}
